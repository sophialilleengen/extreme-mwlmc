...
R,D,M,P = makemodel(einasto,Mtot,[rs,rhos,alpha,rtruncfactor],rvals = 
10.**np.linspace(-5.,0.3,2000),pfile='Einasto_rs{}_rhos{}_alpha{}_rtrunc{}.txt'.format(rs,rhos,alpha,rtruncfactor),plabel = 
'Einasto_rs{}_rhos{}_alpha{}_rtrunc{}.txt'.format(rs,rhos,alpha,rtruncfactor))
